...
static inline ll_unused local_result_t local_ok(uint8_t class, treeF_t free,
						row_id_t start_row)
{
...
static inline ll_unused local_result_t local_fail(uint8_t class, bool present,
						  treeF_t free,
						  row_id_t start_row)
{
